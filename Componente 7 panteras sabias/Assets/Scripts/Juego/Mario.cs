...
public class Mario : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // We check if the A key is pressed
        if (Keyboard.current != null && Keyboard.current.aKey.wasPressedThisFrame)
        {
            Debug.Log("A key pressed by Mario. Detects ground: " + estaEnElSuelo);
    ...
    void Saltar()
    {
        ...
        {
            Debug.LogWarning("Missing adding a Rigidbody to Mario's object!");
        }
    }
}
